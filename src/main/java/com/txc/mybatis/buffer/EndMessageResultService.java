...
/**
 * @ClassName EndMessageResultService
 * @Description TODO
 * @Date 2023/8/31 11:22
 * @Vertion 1.0
 **/
@Service
@Slf4j
public class EndMessageResultService implements MyInterface {
    ...
    public Message decode(ChannelHandlerContext ctx, Message message, ByteBuf in, List<Object> out) throws Exception {
        ...
        log.info("收到关机确认,桩号：{},枪编码：{},结果：{},交易流水号：{}", message.getDevAddr(), spearNum, result, transactionSerialNum);
        return message;
    }
}
